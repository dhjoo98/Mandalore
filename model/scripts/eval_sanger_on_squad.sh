...
model_config=${2:-"bert_base_sanger_2e-3.json"} #donghyeon comment: the model config used.
...
python run_squad_Sanger.py \
    ...
    --output_dir $output_dir/sanger-$(basename $model_name)/
#switch eval_checkpoint once initial training is complete. 