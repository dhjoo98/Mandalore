...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TrainingArguments))
        #donghyeon: cool! so these Argument 'data'classes define what arguments to take in. 
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        #same order as they were passed to initialiser on line 504. 
    ...
    # Detecting last checkpoint.(for continued pretraining | or finetuning)
